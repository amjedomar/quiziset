...
| Swagger UI          | http://localhost:4004/api-docs      | api docs                                                                                       |
...
- **Prisma**
  ...
  - The schema lives in `backend/prisma`
...
- **Nest.js Modules**
  ...
  - A module folder has the three files `*.controller.ts` `*.service.ts`
...
- **Generated api client**
  - `src/generated-api-client` is auto generated by [Orval](https://www.npmjs.com/package/orval) from the
    backend http://localhost:4004/api-docs-json
    OpenAPI json
